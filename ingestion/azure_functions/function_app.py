...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "weatherstreamingn.servicebus.windows.net"
    ...
    def fetch_weather_data():
        ...
        VAULT_URL = "https://kv-weather-streaming12.vault.azure.net/"
        API_KEY_SECRET_NAME = "weatherapikey"
        api_key = get_secret_from_keyvault(VAULT_URL,API_KEY_SECRET_NAME)
